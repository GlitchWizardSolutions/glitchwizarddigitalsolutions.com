...
<html lang='en'>
	...
	<body style="background-color:#F5F6F8;font-size:16px;box-sizing:border-box;font-family:system-ui,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';">
		<div style="box-sizing:border-box;margin:50px auto;background-color:#fff;padding:40px;width:100%;max-width:600px;box-shadow:0 0 7px 0 rgba(0,0,0,.05);">
			<h1 style="box-sizing:border-box;font-size:18px;color:#474a50;padding:0 0 20px 0;margin:0;font-weight:600;border-bottom:1px solid #eee;">Warranty #<?=$id?></h1>
			<p style="margin:0;padding:25px 0;"><?=htmlspecialchars($subject ?? '', ENT_QUOTES)?>! Warranty details are below.</p>
            ...
            <div style="width:100%;padding-bottom:10px;">
                <div style="padding:5px;font-weight:600;font-size:14px;">Warranty Notes</div>
                <div style="padding:5px;font-size:16px;"><?=nl2br(htmlspecialchars($msg ?? ''), ENT_QUOTES)?></div>
            </div>
			<?php endif; ?>
            </div>
			<p>Click <a href="<?=$link?>" style="color:#c52424;text-decoration:none;">here</a> to log into your dashboard.</p>
		</div>
	</body>
</html>