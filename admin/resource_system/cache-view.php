...
<div class="content-block">
    <div class="table">
        <table>
            <thead>
                <tr>
                    <td style='text-align:center; background:grey; color:white; text-transform: uppercase'><strong><?=htmlspecialchars($record['description'], ENT_QUOTES)?></strong></td>
                </tr>
             <tr>
                    <td><strong><?=htmlspecialchars($record['type'], ENT_QUOTES)?></strong></td>
                </tr>    
            </thead>
            <tbody>
      
               <tr>
                    <td><strong>URL:</strong><br><?=htmlspecialchars($record['notes'], ENT_QUOTES)?></td>
               </tr>
        ...
        <table>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td><?=htmlspecialchars($record['username'], ENT_QUOTES)?></td>
                </tr>
                 <tr>
