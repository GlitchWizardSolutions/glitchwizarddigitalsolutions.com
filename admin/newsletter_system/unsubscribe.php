...
<body>
    <div class="container">
        <?php if ($unsubscribed): ?>
            ...
            <a href="<?=defined('BASE_URL') ? BASE_URL : 'https://glitchwizarddigitalsolutions.com/'?>" class="btn">Return to Homepage</a>
        ...
        <?php elseif ($found_subscriber && !$unsubscribed): ?>
            ...
            <form method="post">
                ...
                <br><br>
                <a href="<?=defined('BASE_URL') ? BASE_URL : 'https://glitchwizarddigitalsolutions.com/'?>" class="btn">No, Keep Me Subscribed</a>
            </form>
