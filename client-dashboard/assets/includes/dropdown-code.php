...
<!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo(site_menu_base) ?>client-dashboard/index.php">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?php echo(site_menu_base) ?>client-dashboard/components-badges.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo(site_menu_base) ?>client-dashboard/users-profile.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo(site_menu_base) ?>client-dashboard/pages-register.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo(site_menu_base) ?>client-dashboard/tickets/create.php">
      ...
      <li class="nav-item">
        <a class="nav-link " href="<?php echo(site_menu_base) ?>client-dashboard/pages-blank.php">
