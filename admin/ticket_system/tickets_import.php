...
?>
<?=template_admin_header('Tickets', 'ticketing', 'import')?>
...
<div class="content-title">
    ...
    <div class="txt">
        <h2>Import Client Tickets</h2>
        <p class="subtitle">Upload and import tickets from CSV, JSON, XML, or TXT files</p>
    </div>
</div>
...
<form class="form-professional" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-actions">
        ...
        <input type="submit" name="submit" value="Import Tickets" class="btn btn-primary">
    </div>
