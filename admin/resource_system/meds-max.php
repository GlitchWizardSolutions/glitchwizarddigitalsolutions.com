...
$meds = $onthego_db->query('SELECT * FROM meds WHERE patient = "Max Moore" and status = "Active" ORDER BY name DESC')->fetchAll(PDO::FETCH_ASSOC);
?>
<?=template_admin_header('Medications', 'resources', 'meds')?>
<div class="content-header responsive-flex-column pad-top-5">
    <div class="btns">
        <a href="med.php" class="btn">+ Create New Medication Record</a>
        <a href="meds-max-pdf.php" class="btn" style="background:#dc3545;">Download PDF</a>
...
<div class="modal fade" id="emailModal" tabindex="-1" aria-labelledby="emailModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="meds-max-email.php" method="post">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="recipient_name" class="form-label">Recipient Name</label>
                        <input type="text" class="form-control" id="recipient_name" name="recipient_name" value="Max Moore" required>
                    </div>
                    <div class="mb-3">
                        <label for="recipient_email" class="form-label">Email Address</label>
                        <input type="email" class="form-control" id="recipient_email" name="recipient_email" placeholder="max@example.com" required>
                    </div>
                </div>
