...
if (isset($_POST['file_type'])) {
    // Get all records
    $stmt = $onthego_db->prepare('SELECT * FROM financial_cards ORDER BY id ASC');
    $stmt->execute();
...
?>
<?=template_admin_header('Export records', 'resources', 'cards')?>

<div class="content-title mb-3">
    <div class="title">
    <i class="fa-solid fa-file-export fa-lg"></i>
        <div class="txt">
                  <h2 class="responsive-width-100">Export Financial Institutions</h2>
            <p>Export bank and card records to CSV, TXT, JSON, or XML file</p>
        </div>
    </div>
</div>
