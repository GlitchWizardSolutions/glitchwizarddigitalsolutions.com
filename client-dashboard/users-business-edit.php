    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item"><a href="<?php echo(site_menu_base) ?>client-dashboard/client-businesses.php">My Business Profiles</a></li> 
             ...
             <div class="col-lg-6">
               <div class="card">
                <div class="card-body">
                  ...
                  <form action="users-business-edit.php" id='business-edit-form' class='form' method="post">
                ...
                <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-8 col-md-8">
                        <input name="linkedin" type="text" class="form-control" id="linkedin" placeholder="https://www.linkedin.com/in/" value="<?=htmlspecialchars($invoice_clients['linkedin'] ?? '', ENT_QUOTES)?>" autocomplete="off">
                      </div>
                    </div>
                     <div class="row">
