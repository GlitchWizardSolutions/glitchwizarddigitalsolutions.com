...
<div class="content-header responsive-flex-column pad-top-5">
    <div class="btns">
        <a href="project-types.php" class="btn btn-secondary">Return</a>
        <a href="project-type.php?id=<?=$record['id']?>" class="btn btn-primary">Edit</a>
        <a href="project-types.php?delete=<?=$record['id']?>" onclick="return confirm('Are you sure you want to delete this record?')" class="btn btn-danger">Delete</a>
    </div>
</div>
