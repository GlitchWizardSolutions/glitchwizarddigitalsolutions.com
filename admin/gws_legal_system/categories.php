...
$stmt = $pdo->prepare('SELECT COUNT(*) AS total FROM gws_legal_categories ' . $where);
if ($search) $stmt->bindParam('search', $param3, PDO::PARAM_STR);
$stmt->execute();
$categories_total = $stmt->fetchColumn();
// SQL query to get all categories
$stmt = $pdo->prepare('SELECT * FROM gws_legal_categories ' . $where . ' ORDER BY ' . $order_by . ' ' . $order . ' LIMIT :start_results,:num_results');
// Bind params
...
<div class="content-header responsive-flex-column pad-top-5">
    <a href="category.php" class="btn btn-success">Create Category</a>
