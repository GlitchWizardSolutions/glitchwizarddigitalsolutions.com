...
?>
<?=template_admin_header('Import records', 'resources', 'cards')?>
...
<div class="content-title mb-3">
    ...
    <i class="fa-solid fa-file-import fa-lg"></i>
        <div class="txt">
                  <h2 class="responsive-width-100">Import Financial Institutions</h2>
            <p>Import bank and card records from a CSV file</p>
        </div>
    </div>
</div>
    ...
    <div class="form-professional">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <small>Upload a CSV file with bank and card data</small>
            </div>
        </div>
