...
const openMediaLibrary = options => modal({
        ...
        <div class="dialog large media-library-modal">
            <div class="content">
                ...
                <div class="media">
                    <div class="list">
                        <div class="list-header">
                            <a href="#" class="link_btn upload-media">Upload</a>
                ...
                <div class="footer pad-5">
                    <a href="#" class="submit_btn dialog-close save">${options.buttonText ? options.buttonText : 'Save'}</a>
                </div>
            </div>
        </div>
        `;
    ...
    detailsTemplate: function(media, img) {
        return `
        <form class="media-details-form" method="post" action="connections.php?page=api&action=media&id=${media.id}">
            <h3>Media Details</h3>
            ...
            <input disabled id="full_path" type="text" name="full_path" value="${media.full_path}">
            ...
            <div>
                    <a href="#" class="submit_btn save-media">Save</a> 
                    <a href="#" class="delete_btn delete-media">Delete</a>
            </div>
        </form>
        `;
    },
    ...
    populateMedia: function(data) {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            img.loading = 'lazy';
            img.src = '../consignment_shop/' + data[i].full_path;
    ...
    onOpen: function() {
        fetch('connections.php?page=api&action=media', { cache: 'no-store' }).then(response => response.json()).then(data => {
            this.media = data; 
            this.populateMedia();
        ...
        document.querySelector('.media-library-modal .upload-media').onclick = event => {
            ...
            input.onchange = event => { 
                ...
                fetch('connections.php?page=api&action=media', {
                    method: 'POST',
                    body: form
                ...
                media.forEach(m => {
                    ...
                    document.querySelector('.product-media-container').insertAdjacentHTML('beforeend', `
                        <div class="product-media">
                            ...
                            <a class="media-img" href="../consignment_shop/${m.full_path}" target="_blank">
                                <img src="../consignment_shop/${m.full_path}">
                            </a>
        ...
        modal({
            ...
            modalTemplate: function() {
                ...
                <div class="dialog downloads-modal">
                    <div class="content">
                        ...
                        <div class="footer pad-5">
                            <a href="#" class="submit_btn dialog-close save disabled">Add</a>
                        </div>
                    </div>
                </div>
                `;
            ...
            onOpen: function() {
                this.element.querySelector('.download-file-path').onchange = () => {
                    fetch('connections.php?page=api&action=fileexists&path=' + this.element.querySelector('.download-file-path').value, { cache: 'no-store' }).then(response => response.json()).then(data => {
                ...
                modalTemplate: function() {
                    ...
                    <div class="dialog edit-media-modal">
                        <div class="content">
                            ...
                            <div class="body">
                                <form class="media-details-form" method="post" action="connections.php?page=api&action=media&id=${element.dataset.id}">
                            ...
                            <div class="footer pad-5">
                                <a href="#" class="link_btn dialog-close save">Save</a>
                                <a href="#" class="delete_btn dialog-close delete">Delete</a>
                            </div>
                        </div>
                    </div>
                    `;
