<?php
/*
This page displays all the member tickets in tabs.  The status is as follows:
Review - These are open/reserve status tickets that the admin was the last to respond to.
         If open, the member needs to provide more information.
         If resolved, the member needs to either re-open the ticket with more information, or close the ticket.
Open & Resolved - These are currently being worked.
Closed - Not being worked, and can not be reopened by a member.  (Admin can edit it, though.)
*/
...
<main id="main" class="main">
  ...
  <?php /* ****************   TICKET REVIEWS CLIENT VIEW   **************************************************** */ ?>    
...
<div class="row" id='H'>
  <div class='col-1'></div>
   <div class="col-10"  id='G'>
     <div class="card"  id='F'>
      <div class="card-body"  id='E'>
        <div id='D' class="block tickets"> 
	     <div id='C' class="tickets-list"  id='6'>
          <form action="" id='ticket-id-form' style="width:100%" class='form' method="post"> 
            <input name="respond_ticket_id" type="hidden" id="respond_ticket_id" value="<?=htmlspecialchars($r_ticket['id']?? '', ENT_QUOTES)?>">
            <button class="btn btn-sm btn-success" style='width:55px' type="submit">View</button>  
          </form> 
          <div id='B' class="row ticket col-12">
               <h5>
		 ...
		 <div id='A' class='row col-12'> 
		   <div class='col-1'></div>
		   <div id='A1' class='col-10'>
