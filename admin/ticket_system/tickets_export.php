...
?>
<?=template_admin_header('Tickets', 'ticketing', 'export')?>
...
<div class="content-title">
    ...
    <div class="txt">
        <h2>Export Client Tickets</h2>
        <p class="subtitle">Download all tickets in your preferred format</p>
    </div>
</div>
...
<form class="form-professional" action="" method="post">
    ...
    <div class="form-section">
        ...
        <div class="form-group">
            ...
            <small>Select the format for your exported ticket data</small>
        </div>
