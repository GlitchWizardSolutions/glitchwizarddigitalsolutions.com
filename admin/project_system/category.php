...
?>
<?=template_admin_header($page . ' Project Ticket Category', 'projects', 'catagories')?>
<div class="content-title">
    <div class="title">
        <i class="fa-solid fa-folder"></i>
        <div class="txt">
             <h2 class="responsive-width-100"><?=$page?> Project Ticket Category</h2>
...
<form action="" method="post">
    ...
    <div class="content-title responsive-flex-wrap responsive-pad-bot-3">
        ...
        <a href="categories.php" class="btn mar-right-2">Cancel</a>
        <?php if ($page == 'Edit'): ?>
        <input type="submit" name="delete" value="Delete" class="btn btn-danger mar-right-2" onclick="return confirm('Are you sure you want to delete this category?')">
        <?php endif; ?>
