<!DOCTYPE html>
<?php echo 'This doctype is in client-dashboard.  If you see this message, please let me know, so I can fix it.'; ?>
<html lang='en' class='no-js'>
	<head>
		...
		<title>Portal | GlitchWizard Digital Solutions</title>
