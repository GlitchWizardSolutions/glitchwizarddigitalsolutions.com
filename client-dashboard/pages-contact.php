...
<main id="main" class="main">
    ...
    <section class="section contact">
      ...
      <div class="row gy-4">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Call Us</h3>
                <p>+1 (850) 555-1212<br>+1 (850) 555-5555</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
        ...
        <div class="col-xl-6">
            <p>Feel free to send a test message with the form below.<br> The mailbox is not monitored. <br> Then check your email for the confirmation, to see what this can do.</p>
          <div class="card p-4">
