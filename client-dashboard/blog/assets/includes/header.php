 ...
 include includes_path . 'close-open.php';?>
            ...
            <li class="notification-item">
             ...
             <div class="row mx-auto">
                 ...
                 <div class="row mx-auto" style="text-align:center">
			            ...
			            <button style="width:50%; height:50%" class="btn btn-sm btn-warning mx-auto" type="submit">View Response</button>
                   </div>
                  </form> 
		    </li>
		<?php endforeach; ?>
  ...
  <?php if ($account['role'] == 'Admin'): ?>
   ...
   <!--BREAK-->
            ...
            <li class="nav-item dropdown">
          <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown" title="Recent Clients < 3 Days.">
        ...
        <?php foreach ($active_recently as $ticket): ?>
          <li><hr class="dropdown-divider"></li>
            <li class="notification-item">
               <form action="" id='user_document_form' style="width:100%" class='form' method="post"> 
                <div class="row mx-auto" style='text-align:center'>
                     ...
                     <span style='font-size: 1em'> <?=htmlspecialchars($ticket['document_path'] ?? '', ENT_QUOTES)?> </span> 
                      <span style='font-size:1em'> [<?=time_elapsed_string($ticket['last_seen']) ?>] </span> 
                        <input name="user_document_form" type="hidden" id="user_document_form" value="<?=htmlspecialchars($ticket['document_path']?? '', ENT_QUOTES)?>">
                </div><br>
               <div class="row mx-auto" style="text-align:center">

			           <button style="width:75%; height:50%" class="btn btn-sm btn-warning mx-auto" type="submit">View Documents</button>
                   </div>
                  </form> 
		    </li>
		<?php endforeach; ?>
   ...
   <!--BREAK-->
        ...
        <?php foreach ($admin_project_critical as $ticket): ?>
          <li><hr class="dropdown-divider"></li>
            <li class="notification-item">
               <form action="" id='project-high-id-form' style="width:100%" class='form' method="post"> 
                <div class="row mx-auto">
                     <span style='font-size:.75em'> <?=htmlspecialchars($ticket['title'] ?? '', ENT_QUOTES)?></span> 
                      <br>
                        <input name="respond_project_id" type="hidden" id="respond_project_id" value="<?=htmlspecialchars($ticket['id']?? '', ENT_QUOTES)?>">
                </div>
                 <div class="row mx-auto" style="text-align:center">
			            <button style="width:50%; height:50%" class="btn btn-sm btn-outline-danger mx-auto" type="submit">View Bug</button>
                   </div>
                  </form> 
		    </li>
		<?php endforeach; ?>
               ...
               <form action="" id='respond_project_med' style="width:100%" class='form' method="post"> 
                <div class="row mx-auto">
                 ...
                 <div class="row mx-auto" style="text-align:center">
			            ...
			            <button style="width:50%; height:50%" class="btn btn-sm btn-outline-subtle-dark mx-auto" type="submit">View Ticket</button>
                   </div>
                  </form> 
		    </li>
		<?php endforeach; ?>
