...
if (isset($_POST['submit'])) {
    ...
    if (empty($_FILES['csv']['tmp_name'])) {
        ...
        $columns = ['id', 'resource', 'details', 'url', 'userid', 'password', 'email', 'usage', 'investment', 'type', 'name'];
        // Validate the header
        ...
        if ($header != $columns) {
            ...
            // Import the CSV data
            foreach ($csv as $row) {
                $stmt = $pdo->prepare('INSERT INTO sass_account (id, resource, details, url, userid, password, email, usage, investment, type, name) VALUES (:id, :resource, :details, :url, :userid, :password, :email, :usage, :investment, :type, :name)');
...
?>
<?=template_admin_header('Import SASS Resource records', 'resources', 'sass')?>
...
<div class="content-title mb-3">
    ...
    <i class="fa-solid fa-file-import fa-lg"></i>
        <div class="txt">
                  <h2 class="responsive-width-100">Import SASS Accounts</h2>
            <p>Import records from a CSV file</p>
        </div>
    </div>
</div>
    ...
    <div class="form-professional">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <small>Upload a CSV file with SASS account data</small>
            </div>
        </div>
