...
<div class="content-header responsive-flex-column pad-top-5">
    <div class="btns">
        ...
        <a href="domain.php?id=<?=$records['id']?>" class="btn">Edit</a>
        <a href="domains.php"?delete=<?=$records['id']?>" onclick="return confirm('Are you sure you want to delete this record?')" class="btn">Delete</a>
    </div>
</div>
