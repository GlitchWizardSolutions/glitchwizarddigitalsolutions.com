    ...
    <div class="pagetitle">
      <nav>
        <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item"><a href="<?php echo(site_menu_base) ?>client-dashboard/gws-legal/gws-legal-submit-ticket.php">Create New Requirement</a></li> 
         <li class="breadcrumb-item"><a href="<?php echo(site_menu_base) ?>client-dashboard/gws-legal/gws-legal-review-responses.php">Requirements</a></li> 
