...
<main id="main" class="main">
    ...
    <section class="section">
       ...
       <p>  Use the following pattern to add the Remix icons to anywhere in your project. 
        <code>&lt;i class=&quot;<strong>ri-add-line</strong>&quot;&gt;&lt;/i&gt;</code> Replace the bold part with the below icon names. </p>
         <?php endif; ?>
        <p> Check the <a href="https://remixicon.com/" target="_blank">Official website</a> for more info. </p>
