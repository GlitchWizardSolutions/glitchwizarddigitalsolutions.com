...
<main id="main" class="main">
    ...
    <section class="section">
        <?php if($_SESSION['role']=='Admin'): ?>
         ...
         <p>Use the following pattern to add the Bootstrap icons to anywhere in your project. <code>&lt;i class=&quot;bi <strong>alarm-fille</strong>&quot;&gt;&lt;/i&gt;</code> Replace the bold part with the below icon names.</p>
  <?php endif; ?>
         <p>Check the <a href="https://icons.getbootstrap.com/" target="_blank">Official website</a> for more info.</p>
