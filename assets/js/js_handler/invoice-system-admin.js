        ...
        modalTemplate: function() {
            ...
            <div class="dialog add-client-modal">
                <div class="content">
                    ...
                    <div class="body">
                        <form class="form">
                            <label for="acc_id">Account Id (use 0 if unknown)</label>
                            <input id="acc_id" type="text" name="acc_id" value=0 required>
                            ...
                            <select id="address_country" name="address_country" value="USA">
...
const initManageInvoiceItems = () => {
    ...
    // Add client button (if it exists - it's commented out in some versions)
