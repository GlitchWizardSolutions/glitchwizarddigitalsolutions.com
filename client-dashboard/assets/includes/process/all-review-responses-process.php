<?php
/***********************************************************************************************
PROJECT SYSTEM - all-review-responses-process.php
LOCATION:   /public_html/client-dashboard/assets/includes/process/all-review-responses-process.php
DESCRIBE:   This is for processing the ticket data between the client and the admin.
INPUTREQ:   Ticket id is passed into a session variable.
LOGGEDIN:   REQUIRED - ADMIN ONLY
   ADMIN:   /public_html/admin/
     OUT:   Notifications are on the dashboard, but only visible to the admin.
      IN:   SESSION variables and sql queries
LOG NOTE:   2025-01-12 PRODUCTION  - Active
            2025-01-12 Removed "approved = 1" 
