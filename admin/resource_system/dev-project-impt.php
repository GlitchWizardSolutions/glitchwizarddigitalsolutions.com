...
if (isset($_POST['submit'])) {
    ...
    if (empty($_FILES['csv']['tmp_name'])) {
        ...
        $columns = ['id', 'description','account_id', 'domain_id'];
        // Validate the header
        ...
        if ($header != $columns) {
            ...
            // Import the CSV data
            foreach ($csv as $row) {
                $stmt = $pdo->prepare('INSERT INTO dev_projects (id, description, account_id, domain_id) VALUES (:id, :description, :account_id, :domain_id)');
